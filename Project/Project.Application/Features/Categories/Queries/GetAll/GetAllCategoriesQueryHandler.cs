...
public class GetAllCategoriesQueryHandler(IMapper mapper,IRepository<Category> categoryRepository):IQueryHandler<GetAllCategoriesQuery,PaginatedResult<CategoryDto>>
{
